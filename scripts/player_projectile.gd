...
func setup(new_projectile_id: int, start_position: Vector3, direction: Vector3, projectile_damage: float, projectile_speed: float, projectile_lifetime: float, projectile_hit_radius: float, is_authoritative: bool, player_owner: Node) -> void:
